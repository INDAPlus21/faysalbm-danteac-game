...
//#region
const ai1 = new SimpleAi(document.getElementById("ai1"));
...
const characters = [character1, character2, ai1];
//#endregion

//#region Set character dimensions
document.getElementById("ai1").style.width = `${characterWidth}px`;
document.getElementById("ai1").style.height = `${characterHeight}px`;
